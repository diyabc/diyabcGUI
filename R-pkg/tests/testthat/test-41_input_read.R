...
test_that("read_header", {
    ...
    expect_equal(length(res$n_param_scen), 1)
    expect_equal(length(res$n_param_scen), length(res$scenario_list))
    expect_equal(res$n_param_scen, 8)
    ...
    expect_equal(res$n_scen, length(res$scenario_list))
    expect_equal(length(res$n_param_scen), 6)
    expect_equal(length(res$n_param_scen), length(res$scenario_list))
    expect_equal(res$n_param_scen, c(8L, 8L, 8L, 7L, 7L, 7L))
    ...
    expect_equal(res$n_scen, length(res$scenario_list))
    expect_equal(length(res$n_param_scen), 2)
    expect_equal(length(res$n_param_scen), length(res$scenario_list))
    expect_equal(res$n_param_scen, c(3L, 1L))
    ...
    expect_equal(length(res$n_param_scen), 1)
    expect_equal(length(res$n_param_scen), length(res$scenario_list))
    expect_equal(res$n_param_scen, 9)
    expect_equal(res$n_cond, 2)
    expect_equal(res$n_cond, length(res$cond_list))
    expect_equal(res$simu_mode, "DRAW UNTIL")
    ...
    expect_equal(length(res$n_param_scen), 2)
    expect_equal(length(res$n_param_scen), length(res$scenario_list))
    expect_equal(res$n_param_scen, c(9L, 5L))
    expect_equal(res$n_cond, 2)
    expect_equal(res$n_cond, length(res$cond_list))
    expect_equal(res$simu_mode, "DRAW UNTIL")
    expect_equal(res$n_locus_desc, 28)
